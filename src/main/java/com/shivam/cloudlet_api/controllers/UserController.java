...
public class UserController {
    ...
    @PatchMapping("{userId}")
    public ResponseEntity<Response> completeProfile(@PathVariable String userId,
            @RequestBody CompleteProfileDto profile, @AuthenticationPrincipal User requestingUser) {
        if (!requestingUser.getUserId().equals(userId)) {
    ...
    @DeleteMapping
    public ResponseEntity<Response> deleteUser(@RequestParam String userId) {
